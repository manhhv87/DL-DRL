...
from op_calculate.utils.beam_search import beam_search
...
def generate_instance(size, prize_type):
    # Details see paper
    MAX_LENGTHS = {80: 2.0, 100: 2.0, 150: 2.0, 200: 2.0, 300: 2.0, 500: 2.0}
    ...
    return {
        ...
        "mask": torch.tensor(0, dtype=torch.int64),
    }
                ...
                self.data = [
                    {
                        ...
                        "prize": torch.tensor(prize, dtype=torch.int64),
