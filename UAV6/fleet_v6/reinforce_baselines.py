...
class WarmupBaseline(Baseline):
    ...
    def epoch_callback(self, model, Lmodel, epoch):
        ...
        self.baseline.epoch_callback(model, Lmodel, epoch)
    ...
    def load_state_dict(self, state_dict, Lmodel):
        ...
        self.baseline.load_state_dict(state_dict, Lmodel)
...
class RolloutBaseline(Baseline):
    ...
    def __init__(self, model, Lmodel, problem, opts, epoch=0):
        super(Baseline, self).__init__()
    ...
    def _update_model(self, model, Lmodel, epoch, dataset=None):
        self.model = copy.deepcopy(model)
        self.Lmodel = copy.deepcopy(Lmodel)
    ...
    def epoch_callback(self, model, Lmodel, epoch):
        ...
        candidate_vals = rollout(model, Lmodel, self.dataset, self.opts).cpu().numpy()
