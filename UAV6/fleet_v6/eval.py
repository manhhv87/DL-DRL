...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default=r'F:\论文-Large-scale task scheduling of multi-UAV A deep reinforcement learning approach\TAOP-6-altTrain\fleet_v6\outputs\taop_80\run_20211226T012743\epoch-99.pt')
    parser.add_argument('--Lmodel', type=str, default=r'F:\论文-Large-scale task scheduling of multi-UAV A deep reinforcement learning approach\TAOP-6-altTrain\fleet_v6\outputs\op_80\run_20211226T012743\epoch-1098.pt')
    ...
    opts.datasets = [r'F:\论文-Large-scale task scheduling of multi-UAV A deep reinforcement learning approach\TAOP-6-altTrain\fleet_v6\data\taop_500_seed1234.pkl']
