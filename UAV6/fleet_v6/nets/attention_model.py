...
class AttentionModel(nn.Module):
    ...
    def forward(
        ...
        log_p_veh, pi, veh_list, tour_1, tour_2, tour_3, tour_4, tour_5, tour_6 = (
            self._inner(input, embeddings)
        ...
        (
            ...
            Lmask_dataset5,
            Lmask_dataset6,
        ) = self.problem.LmaskDataset(
            input, tour_1, tour_2, tour_3, tour_4, tour_5, tour_6
        )
        ...
        cost, mask, Ttour_1, Ttour_2, Ttour_3, Ttour_4, Ttour_5, Ttour_6 = (
    ...
    def _inner(self, input, embeddings):
        ...
        return (
            ...
            torch.stack(tour_5, -1),
            torch.stack(tour_6, -1),
        )
    ...
    def sample_many(self, Lmodel, input, batch_rep=1, iter_rep=1):
        ...
        return sample_many(
            ...
            lambda input, tour_1, tour_2, tour_3, tour_4, tour_5, tour_6: self.problem.LmaskDataset(
                input, tour_1, tour_2, tour_3, tour_4, tour_5, tour_6
            ),
            lambda Lmodel, Ltrain, dataset_1, dataset_2, dataset_3, dataset_4, dataset_5, dataset_6: self.problem.get_costs(
                Lmodel,
                Ltrain,
                dataset_1,
                dataset_2,
