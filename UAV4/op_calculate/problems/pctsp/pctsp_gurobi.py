...
def solve_euclidian_pctsp(
    depot, loc, penalty, prize, min_prize, threads=0, timeout=None, gap=None
):
    """
    ...
    penalty_dict = {
        i
        + 1: -p  # We get penalties for the nodes not visited so we 'save the penalties' for the nodes visited
