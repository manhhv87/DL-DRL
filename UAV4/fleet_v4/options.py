...
def get_options(args=None):
    parser = argparse.ArgumentParser(
        ...
        # Data
    parser.add_argument('--problem', default='taop', help="The problem to solve, default 'taop'")
