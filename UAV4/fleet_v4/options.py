...
def get_options(args=None):
    parser = argparse.ArgumentParser(
        description="Attention based model for solving the Task Allocation OP Problem with Reinforcement Learning"
    )
    # Data
    parser.add_argument(
        "--problem", default="taop", help="The problem to solve, default 'taop'"
    )
    parser.add_argument(
        "--graph_size", type=int, default=80, help="The size of the problem graph"
    )
    parser.add_argument(
        "--batch_size",
        type=int,
    ...
    parser.add_argument(
        "--pre_train_epochs",
        default=0,
        help="Number of epochs for pre-training the lower level model",
    )
    parser.add_argument(
        "--pre_trained", default=True, help="Whether to pre-train the lower level model"
    )
    ...
    parser.add_argument(
        "--lr_decay", type=float, default=0.995, help="Learning rate decay per epoch"
    )
    parser.add_argument(
