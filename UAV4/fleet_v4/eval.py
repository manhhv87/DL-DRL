...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", type=str, help="Upper level model to use for evaluation"
    )
    parser.add_argument(
        "--Lmodel", type=str, help="Lower level model to use for evaluation"
    )
    ...
    parser.add_argument(
        "--dataset_path", type=str, help="File path of the testing data"
    )
    ...
    for width in widths:
        eval_dataset(opts.dataset_path, width, opts.softmax_temperature, opts)
