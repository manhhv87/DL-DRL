...
def Run(opts):
    ...
    # Pre-train the lower layer model
    # Lmodel: Lower layer model
    if opts.pre_trained:
    ...
    baselineUpdate = False  # Whether to update the Lmodel of the baseline for the upper level model
                ...
                if (epoch+1) % vehicleNum == 0:
                    ...
                    for train_id in range(vehicleNum):
                        Ltrain_epoch(
                            ...
                            Lbaseline,
                            Llr_scheduler,
                            ((epoch+1)//vehicleNum - 1)*vehicleNum + opts.pre_train_epochs + train_id,
                            Lval_dataset,
                            Lproblem,
                            Ltb_logger,
                            Lopts,
