...
def rollout(model, Lmodel, dataset, opts):
    ...
    def eval_model_bat(bat):
        ...
        with torch.no_grad():
            cost, _ = model(move_to(bat, opts.device), Lmodel)
...
def train_epoch(
    ...
    print(
        "Start Higher level train epoch {}, lr={} for run {}".format(
...
def train_batch(
    model, Lmodel, optimizer, baseline, epoch, batch_id, step, batch, tb_logger, opts
):
